...
namespace HISPlus
{
    ...
    public class Error
    {
        //private static ErrDspForm frmErrorShow;
        public Error()
        {
        }
        ...
        static public void ErrProc(Exception ex)
        {
            try
            {
                ...
                string errMsg = ex.Message + ComConst.STR.CRLF + ex.StackTrace
