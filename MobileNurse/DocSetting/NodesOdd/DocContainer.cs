namespace HISPlus
{
    ...
    public sealed class DocContainer : ContainerControl, IDocNodeParent
    {
        /// <summary>
        /// 列宽
        /// </summary>
        ...
        private void SetChecked(IEnumerable<BaseNode> nodes)
        {
            ...
            foreach (BaseNode node in nodes)
            {
                ...
                {
                    (node as TotalScoreTextBoxNode).SetReferenceNode(this.ChildNodes);
                }
        ...
        private void Save(DocNodeCollection nodes, ref double totalScore)
        {
            ...
            foreach (BaseNode node in nodes)
            {
                ...
                if (((node.Value == null) && !node.IsInList) && (!(node is ScaleTextBoxNode)))
                {
                    record = null;
                }
                else
        ...
        //public void NewForm(int patientId, int visitNo = 0)
        //{
        //    Cursor.Current = Cursors.Default;
        //    try
        //    {
        ...
        //        {
        //            IList<DocNursingRecord> nursingRecords =
        //                new DocNursingRecordDAL().FindByProperty("DocNursing.Id", nursingId);
        ...
        public void NewForm(DocNursing nursing)
        {
            Cursor.Current = Cursors.Default;
            try
            {
                ...
                IList<DocNursingRecord> ilist =
                    new DocNursingRecordDAL().FindByProperty("DocNursing.Id", nursing.Id);
        ...
        //[Browsable(false)]
        //private IEnumerable<BaseNode> DocNodes
        //{
        //    get
        //    {
