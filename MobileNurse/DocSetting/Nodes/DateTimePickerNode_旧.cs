namespace HISPlus
{
    ...
    public class DateTimePickerNode : BaseNode
    {
        ...
        public DateTimePickerNode(DesignTemplate container, DocTemplateElement node, string format)
            : base(container, node)
        {
        ...
        public override object Value
        {
            ...
            set
            {
                if (value is DateTime)
                {
                    ...
                    this._dateTimePicker.Value = d > _dateTimePicker.MinDate ? d : GVars.OracleAccess.GetSysDate();
                    this._dateTimePicker.Checked = true;
                }
                else
                {
                    this._dateTimePicker.Value = GVars.OracleAccess.GetSysDate();
                    this._dateTimePicker.Checked = false;
                }
            }
        }
