...
namespace HISPlus
{
    ...
    /// 表格
    /// </summary>
    internal sealed class GridNode2 : BaseNode
    {
        private readonly PictureEdit _ctl;

        public GridNode2(DesignTemplate container, DocTemplateElement nursingDocNode)
            : base(container, nursingDocNode)
        {
            base.HasValue = false;
            _ctl = new PictureEdit { Tag = this };
            ...
            _ctl.BorderStyle = BorderStyles.NoBorder;
