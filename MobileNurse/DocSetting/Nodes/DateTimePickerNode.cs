...
namespace HISPlus
{
    ...
    public class DateTimePickerNode : BaseNode
    {
        ...
        public DateTimePickerNode(DesignTemplate container, DocTemplateElement node)
            : base(container, node)
        {

            this._dateTimePicker = new DateEdit();
            ...
            this._dateTimePicker.Properties.Mask.EditMask = @"yyyy-MM-dd HH:mm";
            this._dateTimePicker.Properties.EditFormat.FormatString = "yyyy-MM-dd HH:mm";
            this._dateTimePicker.Properties.DisplayFormat.FormatString = "yyyy-MM-dd HH:mm";

            // 默认宽高
            this._dateTimePicker.Size = new Size(150, 22);
