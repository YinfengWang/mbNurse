...
namespace HISPlus
{
    public partial class WristBandPrintFrm : FormDo,IBasePatient
    {
        #region 窗体变量
        ...
        private void WristBandPrintFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblBedLabel.Appearance.Font = new Font("Tahoma", 9F, FontStyle.Bold);
        ...
        private bool getPatientInfo()
        {
            ...
            if (drFind.Length > 0)
            {
                ...
                lblDeptName.Text = drFind[0]["DEPT_NAME"].ToString();

                lblBedLabel.Text = drFind[0]["BED_LABEL"].ToString();
        ...
        private void excelTemplatePrint()
        {
            try
            {
                ...
                string printerName = GVars.IniFile.ReadString("PRINTER", "WristBand", string.Empty);
