...
namespace CommPrinter
{
    public class DataGridViewPrinter
    {
        ...
        protected virtual void CountPageNos(Graphics g)
        {
            ...
            foreach (DataGridViewColumn column3 in this._dataGridView.Columns)
            {
                ...
                else
                {
                    ...
                    int num6 = (int) Math.Ceiling((double) g.MeasureString(column3.HeaderText, new Font(this._dataGridView.ColumnHeadersDefaultCellStyle.Font, FontStyle.Bold), num5).Height);
        ...
        Label_03DA:
            while (item < this._dataGridView.Rows.Count)
            {
