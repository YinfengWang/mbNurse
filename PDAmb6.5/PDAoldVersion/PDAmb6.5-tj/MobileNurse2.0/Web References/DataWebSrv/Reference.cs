...
namespace HISPlus.DataWebSrv {
    ...
    public partial class DataWebSrv : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetOrdersExecuteTimeTest", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")]
        public byte[] GetOrdersExecuteTimeTest(string patientId, string visitId, string start, string stop) {
            object[] results = this.Invoke("GetOrdersExecuteTimeTest", new object[] {
                        patientId,
                        visitId,
                        start,
                        stop});
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetOrdersExecuteTimeTest(string patientId, string visitId, string start, string stop, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetOrdersExecuteTimeTest", new object[] {
                        patientId,
                        visitId,
                        start,
                        stop}, callback, asyncState);
        ...
        /// <remarks/>
        public byte[] EndGetOrdersExecuteTimeTest(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((byte[])(results[0]));
        }
