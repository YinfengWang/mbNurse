...
namespace HISPlus
{
	...
	public class DbAccess
	{
		...
		public virtual void Update(ref DataSet ds, string tableName, string sqlSel)
		{
		}
        ...
        public virtual void Update(ref DataRow[] dataRows, string sqlSel)
        { 
        }
        ...
        public virtual void Update(ref DataSet dsChanged)
        {
        }
