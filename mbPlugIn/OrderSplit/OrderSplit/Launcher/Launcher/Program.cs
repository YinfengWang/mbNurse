    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // 预处理
                LogClass.WriteLog(GVars.Msg.GetMsg("ID005") + ComConst.STR.TAB + GVars.User.UserName);   // 登录系统
                ...
                // 退出处理
				LogClass.WriteLog(GVars.Msg.GetMsg("ID007") + ComConst.STR.TAB + GVars.User.UserName);   // 正常退出
            }
            catch (Exception ex)
            {
                Error.ErrProc(ex);      
        ...
        static private DataSet createAppConfigSchema()
        {
            ...
            drNew["PropertyValue"] = "版权所有：天健源达科技有限公司";
            dtApp.Rows.Add(drNew);
