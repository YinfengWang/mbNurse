...
namespace HISPlus
{
    ...
    public class PersonCls
    {
        ...
        protected string        _gender;                                // 性别: 男/女/未知
        protected DateTime      _birthday;                              // 出生日期

        protected string        _body_Height;                           // 身高
        protected string        _body_Weight;                           // 体重
        #endregion
        ...
        public static int GetAgeYear(DateTime dtBirthday, DateTime dtNow)
        {
            string  strAge      = string.Empty;                         // 年龄的字符串表示
            int     intYear     = 0;                                    // 岁
            int     intMonth    = 0;                                    // 月
