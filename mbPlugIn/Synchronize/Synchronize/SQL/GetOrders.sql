...
instr(replace(ORDERS.administration,'{000}','('),'(')-1)) ADMINISTRATION,
 ...
 WHERE ORDERS.PATIENT_ID = PATS_IN_HOSPITAL.PATIENT_ID AND
       ...
       (ORDERS.ORDER_STATUS='2' OR (ORDERS.ORDER_STATUS='3' AND  ORDERS.STOP_DATE_TIME>SYSDATE AND ORDERS.REPEAT_INDICATOR = 1)) AND
       (repeat_indicator='1' OR (repeat_indicator='0' and start_date_time>=to_date(sysdate-2))) AND  ORDERS.ORDER_CLASS = 'A'
