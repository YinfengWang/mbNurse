...
namespace Xy.Auxiliary.PubCls
{
   public sealed class DBHelperSQL
    {
        ...
        /// <summary> 
        /// 一个有效的数据库连接字符串 如果需要改成连接池,只需要修改本函数即可
        /// </summary> 
        /// <returns></returns> 
        public static string GetConnSting()
        {
            return Customs.Wages.PubCls.PubConstant.ConnectionString;
        }

        static OracleConnection strConn = new OracleConnection(GetConnSting());

        static OracleCommand OracleCommand;
        static OracleTransaction sqlTrans;
        #endregion
        ...
        public static int ExecuteNonQuery(CommandType commandType, string commandText, params OracleParameter[] par)
        {
            try
            {
                return ExecuteNonQuery(GetConnSting(), commandType, commandText, par);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                OracleParameter[] commandParameters = BenLampsonBenLampsonDBHelperParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(OracleConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数 
                OracleParameter[] commandParameters = BenLampsonBenLampsonDBHelperParameterCache.GetSpParameterSet(connection, spName);
        ...
        public static int ExecuteNonQuery(OracleTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                OracleParameter[] commandParameters = BenLampsonBenLampsonDBHelperParameterCache.GetSpParameterSet(transaction.Connection, spName);
        ...
        public static DataTable ExecuteDataTable(CommandType commandType, string commandText, params OracleParameter[] par)
        {
            try
            {
                return ExecuteDataset(GetConnSting(), commandType, commandText, par).Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataSet ExecuteDataset(CommandType commandType, string commandText, params OracleParameter[] par)
        {
            try
            {
                return ExecuteDataset(GetConnSting(), commandType, commandText, par);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataSet ExecuteDataset(CommandType commandType, string commandText)
        {
            try
            {
                return ExecuteDataset(GetConnSting(), commandType, commandText, (OracleParameter[])null);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType, string commandText)
        {
            try
            {
                return ExecuteDataset(connectionString, commandType, commandText, (OracleParameter[])null).Tables[0];
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// <returns>返回一个包含结果集的第一个DataTable</returns> 
        public static DataTable ExecuteDataTable(OracleConnection connection, CommandType commandType, string commandText)
        {
            return ExecuteDataset(connection, commandType, commandText, (OracleParameter[])null).Tables[0];
        }
        ...
        public static bool Transaction(ArrayList array)
        {
            //string LogDirName = "SysLog"; //日志目录名称
            ...
            sqlTrans = strConn.BeginTransaction();
            OracleCommand = new OracleCommand();
            OracleCommand.Connection = strConn;
            OracleCommand.Transaction = sqlTrans;
            try
            {
                foreach (string arr in array)
                {
                    OracleCommand.CommandText = arr.ToString();
            ...
            catch (Exception e)
            {
                ...
                //sqlTrans.Rollback();
                //Customs.Wages.PubCls.PubConstant.OuPLogs(Customs.Wages.PubCls.PubConstant.GetFileName(), Customs.Wages.PubCls.PubConstant.GetMethod(),
                //    Customs.Wages.PubCls.PubConstant.GetLineNum(), e.Message, LogDirName);
                return false;
            }
            finally
            {
   ...
   /// <summary> 
   /// BenLampsonBenLampsonDBHelperParameterCache提供缓存存储过程参数,并能够在运行时从存储过程中探索参数. 
   /// </summary> 
   public sealed class BenLampsonBenLampsonDBHelperParameterCache
   {
       #region 私有方法,字段,构造函数

       // 私有构造函数,妨止类被实例化. 
       private BenLampsonBenLampsonDBHelperParameterCache() { }
