    ...
    public sealed class OracleHelper
    {
        ...
        private static string ConnectionString
        {
            get
            {
                ...
                return OracleHelper._ConnectionString;
            }
            set { OracleHelper._ConnectionString = value; }
        }
        ...
        /// <param name="commandText">存储过程名或都T-Oracle命令文本</param> 
        ...
        {
            TJComm comm = new TJComm();
            //此连接字符串较简单，可扩展加入更多参数
            return "Data Source=" + Common.Static.GetWebConfigValueWLog("ORA")
                + ";USER=" + comm.descript(Common.Static.GetWebConfigValueWLog("ORAUSER"))
                + ";PASSWORD=" +
                comm.descript(Common.Static.GetWebConfigValueWLog("ORAPASSWORD")) + ";";
        }
        ...
        /// <remarks> 
        /// 示例:  
        ///  int result = ExecuteNonQuery( "select * from dual"); 
        /// </remarks>   
        /// <param name="commandText">SQL语句</param> 
        /// <returns>返回命令影响的行数</returns> 
        public static int ExecuteNonQuery(string commandText)
        {
            return ExecuteNonQuery(CommandType.Text, commandText, (OracleParameter[])null);
        }
        /// <summary> 
        /// 执行SQL语句,返回受影响行数 
        /// </summary> 
        ...
        {
            return ExecuteNonQuery(commandType, commandText, (OracleParameter[])null);
        }
        ...
        /// <remarks> 
        /// 示例:  
        ///  int result = ExecuteNonQuery( "select..from .. where..", new OracleParameter("@prodid", 24)); 
        /// </remarks> 
        ...
        public static int ExecuteNonQuery(string commandText, params OracleParameter[] commandParameters)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                ...
                PrepareCommand(cmd, connection, (OracleTransaction)null, CommandType.Text, commandText, commandParameters, out mustCloseConnection);
        ...
        /// <param name="commandParameters">OracleParamter参数数组</param> 
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQuery(CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                // 创建OracleCommand命令,并进行预处理 
        ...
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQuery(OracleConnection connection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            // 如果有参数值 
            if ((parameterValues != null) && (parameterValues.Length > 0))
        ...
        /// <param name="commandText">存储过程名称或T-SQL语句</param> 
        /// <returns>返回影响的行数/returns> 
        private static int ExecuteNonQuery(OracleTransaction transaction, CommandType commandType, string commandText)
        {
        ...
        /// <param name="commandParameters">OracleParamter参数数组</param> 
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQuery(OracleTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回受影响的行数</returns> 
        private static int ExecuteNonQuery(OracleTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="commandParameters">OracleParamter参数数组</param> 
        /// <returns>返回一个包含结果集的DataSet</returns> 
        private static DataSet ExecuteDataset(CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                // 预处理 
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回一个包含结果集的DataSet</returns> 
        private static DataSet ExecuteDataset(OracleConnection connection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
        ...
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <returns>返回一个包含结果集的DataSet</returns> 
        private static DataSet ExecuteDataset(OracleTransaction transaction, CommandType commandType, string commandText)
        {
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回一个包含结果集的DataSet</returns> 
        private static DataSet ExecuteDataset(OracleTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// </remarks>       
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <param name="commandParameters">OracleParamter参数数组(new OracleParameter("@prodid", 24))</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        public static OracleDataReader ExecuteReader(string commandText, params OracleParameter[] commandParameters)
        {
        ...
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(string ConnectionString, CommandType commandType, string commandText)
        {
        ...
        /// <param name="commandParameters">OracleParamter参数数组(new OracleParameter("@prodid", 24))</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(string ConnectionString, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(string ConnectionString, string spName, params object[] parameterValues)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            if ((parameterValues != null) && (parameterValues.Length > 0))
        ...
        /// <param name="commandText">存储过程名或T-SQL语句</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(OracleConnection connection, CommandType commandType, string commandText)
        {
        ...
        /// <param name="commandParameters">OracleParamter参数数组</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(OracleConnection connection, string spName, params object[] parameterValues)
        {
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
        ...
        /// <param name="commandText">存储过程名称或T-SQL语句</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(OracleTransaction transaction, CommandType commandType, string commandText)
        {
        ...
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(OracleTransaction transaction, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReader(OracleTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        {
            // 执行参数为空的方法 
            return ExecuteScalar(CommandType.Text, commandText, (OracleParameter[])null);
        }
        /// <summary> 
        /// 执行SQL,返回结果集中的第一行第一列. 
        /// </summary> 
        ...
        {
            // 执行参数为空的方法 
            return ExecuteScalar(commandType, commandText, (OracleParameter[])null);
        }
        /// <summary> 
        ...
        /// <param name="commandParameters">分配给命令的OracleParamter参数数组</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalar(CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                // 创建OracleCommand命令,并进行预处理 
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalar(OracleConnection connection, string spName, params object[] parameterValues)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 如果有参数值 
        ...
        /// <param name="commandText">存储过程名称或T-SQL语句</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalar(OracleTransaction transaction, CommandType commandType, string commandText)
        {
            // 执行参数为空的方法 
        ...
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalar(OracleTransaction transaction, string spName, params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        private static void FillDataset(string ConnectionString, CommandType commandType, string commandText, DataSet dataSet, string[] tableNames)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
        ...
        /// 用户定义的表名 (可有是实际的表名.) 
        /// </param> 
        private static void FillDataset(string ConnectionString, CommandType commandType,
        ...
        /// 用户定义的表名 (可有是实际的表名.) 
        /// </param>    
        private static void FillDataset(OracleConnection connection, CommandType commandType,
            string commandText, DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param> 
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        private static void FillDataset(OracleConnection connection, string spName,
            DataSet dataSet, string[] tableNames,
            params object[] parameterValues)
        {
            {
        ...
        /// 用户定义的表名 (可有是实际的表名.) 
        /// </param> 
        private static void FillDataset(OracleTransaction transaction, CommandType commandType,
            string commandText,
            DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param> 
        /// <param name="parameterValues">分配给存储过程输入参数的对象数组</param> 
        private static void FillDataset(OracleTransaction transaction, string spName,
            DataSet dataSet, string[] tableNames,
            params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
        ...
        private static void UpdateDataset(OracleCommand insertCommand, OracleCommand deleteCommand, OracleCommand updateCommand, DataSet dataSet, string tableName)
        {
        ...
        /// <summary> 
        /// 执行数据集更新到数据库,指定SelectString
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ///  UpdateDataset("select * from table", "Order"); 
        /// </remarks>         
        /// <param name="SelectString">读取将更新数据的SQL语句</param> 
        /// <param name="tableName">要更新到数据库的DataTable</param> 
        public static void UpdateDataset(string SelectString, DataTable tableName)
        {
            OracleDataAdapter Adapter = new OracleDataAdapter();
            using (OracleConnection connection = new OracleConnection(ConnectionString))
            {
                Adapter.SelectCommand = new OracleCommand(SelectString, connection);
        ...
        private static OracleCommand CreateCommand(OracleConnection connection, string spName, params string[] sourceColumns)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 创建命令 
        ...
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQueryTypedParams(String ConnectionString, String spName, DataRow dataRow)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            // 如果row有值,存储过程必须初始化. 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQueryTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 如果row有值,存储过程必须初始化. 
                if (dataRow != null && dataRow.ItemArray.Length > 0)
                {
                    ...
                    // 分配参数值 
                    AssignParameterValues(commandParameters, dataRow);
                    return OracleHelper.ExecuteNonQuery(CommandType.StoredProcedure, spName, commandParameters);
                }
                else
                {
                    return OracleHelper.ExecuteNonQuery(CommandType.StoredProcedure, spName);
                }
            }
        }
        /// <summary> 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回影响的行数</returns> 
        private static int ExecuteNonQueryTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回一个包含结果集的DataSet.</returns> 
        private static DataSet ExecuteDatasetTypedParams(string ConnectionString, String spName, DataRow dataRow)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            //如果row有值,存储过程必须初始化. 
        ...
        /// <returns>返回一个包含结果集的DataSet.</returns> 
        /// 
        private static DataSet ExecuteDatasetTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 如果row有值,存储过程必须初始化. 
                if (dataRow != null && dataRow.ItemArray.Length > 0)
                {
                    ...
                    // 分配参数值 
                    AssignParameterValues(commandParameters, dataRow);
                    return OracleHelper.ExecuteDataset(CommandType.StoredProcedure, spName, commandParameters);
                }
                else
                {
                    return OracleHelper.ExecuteDataset(CommandType.StoredProcedure, spName);
                }
            }
        }
        /// <summary> 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回一个包含结果集的DataSet.</returns> 
        private static DataSet ExecuteDatasetTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReaderTypedParams(String ConnectionString, String spName, DataRow dataRow)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            // 如果row有值,存储过程必须初始化. 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReaderTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 如果row有值,存储过程必须初始化. 
                if (dataRow != null && dataRow.ItemArray.Length > 0)
                {
                    ...
                    // 分配参数值 
                    AssignParameterValues(commandParameters, dataRow);
                    return OracleHelper.ExecuteReader(CommandType.StoredProcedure, spName, commandParameters);
                }
                else
                {
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回包含结果集的OracleDataReader</returns> 
        private static OracleDataReader ExecuteReaderTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalarTypedParams(String ConnectionString, String spName, DataRow dataRow)
        {
            if (ConnectionString == null || ConnectionString.Length == 0) throw new ArgumentNullException("ConnectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            // 如果row有值,存储过程必须初始化. 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalarTypedParams(OracleConnection connection, String spName, DataRow dataRow)
        {
            {
                if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
                // 如果row有值,存储过程必须初始化. 
                if (dataRow != null && dataRow.ItemArray.Length > 0)
                {
                    ...
                    // 分配参数值 
                    AssignParameterValues(commandParameters, dataRow);
                    return OracleHelper.ExecuteScalar(CommandType.StoredProcedure, spName, commandParameters);
                }
                else
                {
                    return OracleHelper.ExecuteScalar(CommandType.StoredProcedure, spName);
                }
            }
        }
        /// <summary> 
        ...
        /// <param name="dataRow">使用DataRow作为参数值</param> 
        /// <returns>返回结果集中的第一行第一列</returns> 
        private static object ExecuteScalarTypedParams(OracleTransaction transaction, String spName, DataRow dataRow)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
            if (transaction != null && transaction.Connection == null) throw new ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
